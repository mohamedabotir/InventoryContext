...
public class ConsumerHostingService(ILogger<ConsumerHostingService> _logger,IServiceProvider _serviceProvider,IOptions<InventoryTopic> _topic):IHostedService
{
